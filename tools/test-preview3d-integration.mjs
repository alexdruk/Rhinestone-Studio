...
await test('11. no forbidden file changed (this milestone\'s own forbidden list)', () => {
  ...
  const forbiddenPrefixes = [
    ...
    'src/geometry/', 'src/export/', 'src/text/', 'src/fonts/', 'src/browser/', 'src/svg/', 'src/history/', 'src/products/', 'src/renderer/'
  ];
