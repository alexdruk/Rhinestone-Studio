...
Items 1–4 exercise `src/products/index.js` directly. Items 5–13 extract and **really execute** the
...
`tools/test-ui-import-autoswitch-regression.mjs`). Items 6, 7, 8, 9, and 12 were mutation-tested:
