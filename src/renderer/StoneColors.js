 ...
 * consumer — `CanvasRenderer2D.js`, `CupRenderer.js` (via `drawStone`), `StoneLayoutTexture.js`,
 * `SvgExporter.js`, `ProductionSheetExporter.js`, and app.js's own top-level STONE_COLORS import
 * from this exact file path — keeps working with zero code changes.
 */
