 ...
 * exactly as before. FONT-002: the lookup mechanism itself (flat pair-keyed map, 0 fallback) is
 * shared with RS Modern via ../kerningTable.js -- only the pair data below is RS Block-specific.
 */
